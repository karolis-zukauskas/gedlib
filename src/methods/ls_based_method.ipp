...
ged_parse_option_(const std::string & option, const std::string & arg) {
	...
	if (option == "initialization-method") {
      ...
      initialization_method_ = new Star2<UserNodeLabel, UserEdgeLabel>(this->ged_data_);
    }
    else if (arg == "STAR3") {
      initialization_method_ = new Star3<UserNodeLabel, UserEdgeLabel>(this->ged_data_);
    }
    else if (arg == "STAR4") {
      initialization_method_ = new Star4<UserNodeLabel, UserEdgeLabel>(this->ged_data_);
    }
    else if (arg == "STAR5") {
      initialization_method_ = new Star5<UserNodeLabel, UserEdgeLabel>(this->ged_data_);
    }
    else if (arg == "STAR6") {
