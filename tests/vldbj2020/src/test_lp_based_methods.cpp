...
/*!
 * @file tests/vldbj2019/src/test_lp_based_methods.cpp
...
void test_on_dataset(const std::string & dataset) {
  ...
  std::vector<ged::Options::GEDMethod> ged_methods{ged::Options::GEDMethod::F1, ged::Options::GEDMethod::F2, ged::Options::GEDMethod::COMPACT_MIP, ged::Options::GEDMethod::BLP_NO_EDGE_LABELS};
